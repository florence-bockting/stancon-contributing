...
+ What's your (current) primary programming language? (R / Python / C++)
+ Have you already contributed to open-source software? (Yes?)
+ Have you already contributed to Stan? (Yes?)
