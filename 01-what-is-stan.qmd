...
By the end of this section, you'll understand that Stan is more than a 
probabilistic programming language for specifying statistical models; it is 
also an open-source community and a broader software ecosystem.
